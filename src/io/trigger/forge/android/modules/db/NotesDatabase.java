...
public class NotesDatabase extends FetchDB{
	...
	static final String[] TABLE_NAMES = new String[]{"Notes","NoteTag","NoteContacts","NoteEmail","NoteURL","Time","User"};
	...
	/*tatic final String TAG_STRING = "tags",
						CONTACT_STRING = "contacts",
						EMAIL_STRING = "emails",
						URL_STRING = "urls";*/
	
	//static final String[] entityStrings = new String[]{TAG_STRING,CONTACT_STRING,EMAIL_STRING,URL_STRING}; 
...
/*	public synchronized Note addNewNote(String text,String server_id,String timestamp  ){
	...
	private synchronized void updateNoteValues(Note note, String newText, String server_id,String timestamp){
		open();
